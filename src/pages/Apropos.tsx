  ...
  return (
    <Container maxWidth="md" sx={{ py: 6 }}>
      <Paper
        elevation={3}
        sx={{
          minHeight: "160vh", // Paper deux fois plus grand
          width: "100%",
      ...
      >
        ...
        <Grid container spacing={3} sx={{ mt: 3 }}>
          <Grid item xs={12} md={4}>
            <Card sx={{ backgroundColor: "#EFE9AE", p: 3, textAlign: "center" }}>
              <CardContent>
        ...
        <Grid container spacing={3} sx={{ mt: 5 }}>
          <Grid item xs={12}>
            <Card sx={{ backgroundColor: "#A4C3B2", p: 4, textAlign: "center", color: "white" }}>
              <CardContent>
                <Typography variant="h6">
                La naissance d’ODIA
          ...
          <Grid item xs={12} md={6}>
            <Card sx={{ backgroundColor: "#A4C3B2", p: 3, textAlign: "center", color: "white" }}>
              <CardContent>
                <Typography variant="body1">
                  ODIA:
                  Optimisation et Développement d'inteligence Accessible
                </Typography>
              </CardContent>
            </Card>
          </Grid>
